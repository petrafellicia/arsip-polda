          ...
          <div class="card-body">
            <form method="POST" action="/updatedatakeluar/{{ $data->id }}" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="no_agenda" value="{{ $data->no_agenda}}" class="form-control"
                  id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">Nomor Surat</label>
                <input type="text" name="no_surat" value="{{ $data->no_surat }}" class="form-control"
              ...
              <div class="mb-3">
                ...
                <input type="text" name="id_pengirim" value="{{ $dt->nama_penerima }}" class="form-control"
                  id="exampleInputPassword1">
                @endforeach
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="date" name="tgl_surat" value="{{ $data->tgl_surat }}" class="form-control"
                  id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
              <div class="mb-3">
